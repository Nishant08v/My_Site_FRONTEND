...
const PlaceItem = props =>{
    ...
    return (
        ...
        contentClass = "place_item_modal-content"
        footerClass = "place_item_modal-actions"
        footer = {<Button onClick = {closeMapHandler}>CLOSE</Button>}
        >
      <div className="map-container">
        <OLMap center = {props.coordinates} zoom = {16}/>
      </div>
        </Modal>
        <Modal show = {showConfirmModal} onCancel = {cancelDeleteHandler} header="Are You Sure?"
         footerClass = "place_item_modal-actions" footer = {
            <React.Fragment>
            ...
            <p>Do you want to proceed & delete this place? Please note that it can't be undone thereafter</p>
        </Modal>
